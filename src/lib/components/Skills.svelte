...
<section id="skills" class="bg-dark-300/50 py-24">
		...
		{#if inView}
			<div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
				<div in:fly={{ y: 50, duration: 500, delay: 100 }}>
					<SkillCard title="Frontend Development" icon="layout" skills={frontendSkills} />
				</div>

				<div in:fly={{ y: 50, duration: 500, delay: 200 }}>
					<SkillCard title="Backend Development" icon="server" skills={backendSkills} />
				</div>
				...
				<div in:fly={{ y: 50, duration: 500, delay: 500 }}>
					<SkillCard title="Performance Optimization" icon="zap" skills={performanceSkills} />
				</div>
