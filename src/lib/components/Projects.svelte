<script>
  ...
  const projects = [
    ...
    },
    {
      ...
      githubUrl:
        "https://github.com/sritejachilakapati/Common-Election-Portal-Server",
...
<section id="projects" class="py-24 relative">
  <div class="container max-w-7xl mx-auto px-6">
    ...
    <div
      class="hidden md:block absolute left-1/2 top-[18rem] bottom-32 w-px bg-primary bg-opacity-30 transform -translate-x-1/2 z-10"
    />

    {#if inView}
      <div class="relative space-y-32">
        <!-- Disclaimer -->
        <div class="text-center text-dark-100 italic text-sm mb-12">
          * Some project images are visualizations of concepts. These are either
          in-progress or backend-only projects
        </div>
